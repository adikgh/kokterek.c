...
<? include 'block/header.php'; ?>
	...
	<div class="bl1">
		...
		<div class="bl1_a bl1_a1 lazy_bag" data-src="/assets/img/2662684.jpg"></div>

		<div class="bl_c">
			<div class="bl1_c">
				<div class="bl1_offer">Откройте для себя <br> комфорт и лечение</div>
				<div class="bl1_offer2">Санаторий Коктерек</div>
				<div class="bl1_disc">Забронируйте свой идеальный отдых <br> в тёплых лечебных водах Сарыагаша</div>
				<div class="form_c">
					<div class="form_im"><div class="btn disb_zab">Окунитесь в целебные воды</div></div>
				</div>
			</div>
		</div>
		...
		<div class="bl_c">
			<div class="head_c">
				<div class="head_v1 txt_c">
					<h1>Целебные воды, лечебные <br> источники и комфортный отдых</h1>
					<div class="head_vt" >и это все Коктерек</div>
				</div>
			</div>
			<div class="blj2_c">
				<div class="blj2_i">
			...
			<div class="blj3_c">
				...
				<div class="blj3_cn">
					...
					<div class="blj3_i">
						...
						<div class="blj3_ip">Санаторий находится всего в 2 часа от Шымкента и легко доступен через удобные транспортные пути.</div>
					</div>
					<div class="blj3_i">
						<div class="blj3_it">02.</div>
						<div class="blj3_ih">Уютные, современные номера</div>
						<div class="blj3_ip">Каждый номер оборудован всем необходимым для комфортного проживания и эффективного лечения.</div>
					</div>
					<div class="blj3_i">
						<div class="blj3_it">03.</div>
						<div class="blj3_ih">Целебные воды и восстановление энергии</div>
						<div class="blj3_ip">Наслаждайтесь целебными водами и восстанавливайте силы в окружении природы, наполняющей вас новой энергией.</div>
					</div>
					<div class="blj3_i">
						<div class="blj3_it">04.</div>
						<div class="blj3_ih">Тишина и уединение</div>
						<div class="blj3_ip">Санаторий расположен вдали от шума города, обеспечивая полное уединение и отдых от городской суеты.</div>
					</div>
	...
	<div class="sana_bl2" id="numbers">
		<div class="bl_c">
            ...
            <div class="sana_bl2_c">
                ...
                <? $sql = db::query("select * from sanatorium_number where arh is null ORDER BY number ASC "); ?>
                <? while ($ana = mysqli_fetch_array($sql)): ?>
                    <div class="bl5_i">
                        <div class="bl5_ic">
							<div class="bl5_icb">
